...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.loginhereTextController ??= TextEditingController();
    _model.loginhereFocusNode ??= FocusNode();
                  ...
                  children: [
                    Align(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/jill_(1)_processed.png',
                          width: 400.0,
                          height: 180.0,
                          fit: BoxFit.cover,
                        ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.loginhereTextController,
                                          focusNode: _model.loginhereFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.loginhereTextController',
                                            const Duration(milliseconds: 2000),
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .loginhereTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      SizedBox(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                await SendEmailCall.call(
                                  ...
                                  text:
                                      'This is an email confirming your account creation.',
                                );
